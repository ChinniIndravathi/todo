    ...
    TodoApp.prototype.renderTasks = function () {
        ...
        */
        ...
        this.todoTasks.forEach(function (todoTask) {
            _this.todoItemsHTML.innerHTML += "\n                <li class=\"".concat(todoTask.completed ? 'completed' : 'notcompleted', "\">\n                    ").concat(todoTask.task, "\n                    <button id=\"done-button\" class=\"fas fa-check\" onclick=\"todoApp.markCompleted(").concat(todoTask.id, ")\"></button>\n                    <button id=\"delete-icon\" class=\"fas fa-trash-alt delete-icon\" onclick=\"todoApp.removeTask(").concat(todoTask.id, ")\"></button>\n                </li>\n            ");
        });
    };
    return TodoApp;
}());
